...
export class GoogLeNetBN extends CaffeModel {
  ...
  constructor() {
    super(
        MODEL_DIR + GoogLeNetBN.caffemodel, GITHUB_CDN + GoogLeNetBN.prototxt);
  }
}
...
export class SqueezeNet extends CaffeModel {
  ...
  static caffemodel =
      'DeepScale/SqueezeNet/master/SqueezeNet_v1.1/squeezenet_v1.1.caffemodel';
  static prototxt =
      'DeepScale/SqueezeNet/master/SqueezeNet_v1.1/deploy.prototxt';
...
export class VGG16 extends CaffeModel {
  ...
  static prototxt =
      'ksimonyan/211839e770f7b538e2d8/raw/ded9363bd93ec0c770134f4e387d8aaaaa2407ce/VGG_ILSVRC_16_layers_deploy.prototxt';
...
export class NiN extends CaffeModel {
  ...
  // tslint:disable-next-line:max-line-length
  static prototxt =
      'tzutalin/0e3fd793a5b13dd7f647/raw/207d710d2e089423eda4b0b76ca4b139b7a461f7/deploy.prototxt';
...
export class AgeNet extends CaffeModel {
  ...
  // tslint:disable-next-line:max-line-length
  static prototxt =
      'GilLevi/c9e99062283c719c03de/raw/ddd9cf649c323041ee6e4731ff45636a09261597/deploy_age.prototxt';
  static meanfile =
      'GilLevi/AgeGenderDeepLearning/master/models/mean.binaryproto';
  ...
  constructor() {
    super(
        MODEL_DIR + AgeNet.caffemodel, GITHUB_GIST + AgeNet.prototxt,
        GITHUB_CDN + AgeNet.meanfile);
  }
}
...
export class GenderNet extends CaffeModel {
  ...
  // tslint:disable-next-line:max-line-length
  static prototxt =
      'GilLevi/c9e99062283c719c03de/raw/ddd9cf649c323041ee6e4731ff45636a09261597/deploy_gender.prototxt';
  static meanfile =
      'GilLevi/AgeGenderDeepLearning/master/models/mean.binaryproto';
  ...
  constructor() {
    super(
        MODEL_DIR + GenderNet.caffemodel, GITHUB_GIST + GenderNet.prototxt,
        GITHUB_CDN + GenderNet.meanfile);
  }
}
